            ...
            if (obj0 == "Ok") {
                for (var i = 0; i < obj.length; i++) {
                    ...
                    content += '<div class="card ml-3 " style="width: 97%;"><div class="card-body p-1"><div class="col-md-2"></div><div class="col-md-10">' +
                        '<h5 id="username_Comment" class="card-title">Card title</h5>' +
                        '<p id="comment_Text" class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p >' +
                        '</div></div></div>';
